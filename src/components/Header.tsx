...
function NavLink({ href, label, isActive, onClick }: NavLinkProps): React.JSX.Element {
  return (
    <a
      href={href}
      onClick={onClick}
      className={`px-3 py-2 text-sm font-tt-firs-medium transition-all duration-300 ${
...
export default function Header(): React.JSX.Element {
  ...
  const socialLinks = [
    ...
    {
      name: 'Telegram',
      href: 'https://t.me/Push_fun_Portal',
      icon: (
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-sm border-b border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
           <Image src="/hd2.png" alt="Push.fun" width={180} height={100} />
          </div>
          ...
          <nav className="hidden lg:block">
            <div className="ml-10 flex items-baseline space-x-4">
              ...
              <NavLink 
                href="#pump-with-fun" 
                label="Features" 
                isActive={activeSection === "pump-with-fun"} 
              />
              <NavLink 
                href="#user-groups" 
                label="Users" 
                isActive={activeSection === "user-groups"} 
              />
              <NavLink 
                href="#more-powers" 
                label="Powers" 
                isActive={activeSection === "more-powers"} 
              />
              <NavLink 
                href="#tokenomics" 
                label="Tokenomics" 
          ...
          {/* Desktop Social Links - Hidden below lg (1024px) */}
              ...
              if (hasLink) {
                return (
                  <a
                    ...
                    className="text-gray-300 hover:text-orange-500 transition-colors duration-200 p-2 rounded-lg hover:bg-gray-800/50"
          ...
          <div className="lg:hidden">
            <button
              ...
              className="bg-gray-800/50 inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700/50 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-orange-500 transition-colors duration-200"
      ...
      <div className={`lg:hidden transition-all duration-300 ease-in-out ${
        ...
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-zinc-900/95 backdrop-blur-sm border-b border-white/10">
                ...
                if (hasLink) {
                  return (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-gray-300 hover:text-orange-500 transition-colors duration-200 p-3 rounded-lg hover:bg-gray-800/50"
                      aria-label={link.name}
                    >
                      {link.icon}
                    </a>
