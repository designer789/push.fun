...
export default function Footer(): React.JSX.Element {
  ...
  return (
    <footer className="relative overflow-hidden bg-zinc-900/50 backdrop-blur-sm border-t border-white/10">
      {/* Background accents */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col items-center space-y-8">
          ...
          {/* Copyright */}
          <div className="text-center text-gray-400 font-tt-firs-regular">
            <p>&copy; {currentYear} Push.fun. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
